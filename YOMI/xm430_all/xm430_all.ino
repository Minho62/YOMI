...
void set_all_motors(Stream &serialport, float velocity[12], float position[12]) {
  xm430_Torque(serialport, 0xFE, 0);
  ...
  xm430_Torque(Serial1, 0xFE, 1);


  for (int i = 0; i < 10; i++) {
    xm430_position(serialport, motor_id[i], position[i]);
  }
}
...
void loop() {
  float velocity_set1[10] = { 70, 70, 70, 70, 70, 70, 70, 70, 70, 70};
  float position_set1[10] = { 180, 180, 180, 180, 180, 180, 180, 180, 180, 180};
  float velocity_set2[10] = { 70, 70, 70, 70, 70, 70, 70, 70, 70, 70};
  float position_set2[10] = { 180, 180, 180, 180, 180, 180, 180, 180, 180, 180};
